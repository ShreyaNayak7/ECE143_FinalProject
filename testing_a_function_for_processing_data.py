...
"""
import pandas as pd
from gather_data import DataHandler as gd
import plot_functions as pf
import continent_country_map as cmap
from functions_for_processing_data import process_data
...
hl_c=process_data.return_modified_data_frame(hl_raw,[('Financing_scheme',"All financing schemes"), ("Function","Current expenditure on health (all functions)") , ("Provider","All providers") , ("Measure","Share of gross domestic product" ) ])
'''
